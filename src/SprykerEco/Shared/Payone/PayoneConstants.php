...
interface PayoneConstants
{
    ...
    const PAYONE_EXPRESS_CHECKOUT_PROJECT_FAILURE_URL = 'PAYONE_EXPRESS_CHECKOUT_PROJECT_FAILURE_URL';
    const PAYONE_EXPRESS_CHECKOUT_PROJECT_BACK_URL = 'PAYONE_EXPRESS_CHECKOUT_PROJECT_BACK_URL';
