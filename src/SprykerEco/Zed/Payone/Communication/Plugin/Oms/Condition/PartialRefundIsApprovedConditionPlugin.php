 ...
 */
class PartialRefundIsApprovedConditionPlugin extends SprykerAbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
     * - Checks if payone order item status is `refund approved`.
     *
     * @api
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $payoneOrderItemStatus === PayoneTransactionStatusConstants::STATUS_REFUND_APPROVED;
    }
}
